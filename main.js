...
(function() {
  var Application, FOG, PLAYER_HEIGHT, Utils, World, WorldPrimitives,
  ...
  World = (function() {
    ...
    World.prototype.init_renderer = function() {
      var directionalLight, skybox,
        _this = this;
      this.camera.position.x = this.width * 100 / 2;
      this.camera.position.z = this.width * 100 / 2;
      if (FOG) {
        this.scene.fog = new THREE.FogExp2(0xff0000, 0.00004);
      }
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(0, 0, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(0, 1, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(0, 2, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(1, 0, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(1, 2, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(2, 0, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(2, 1, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(2, 2, 2);
      }));
      this.scene.add(Utils.time(function() {
        return _this.draw_sector(1, 1, 1);
      }));
      ...
      for (x = _j = 0, _ref = this.width - 1; 0 <= _ref ? _j <= _ref : _j >= _ref; x = 0 <= _ref ? ++_j : --_j) {
        _results.push((function() {
          ...
          for (y = _k = 0, _ref1 = this.height - 1; 0 <= _ref1 ? _k <= _ref1 : _k >= _ref1; y = 0 <= _ref1 ? ++_k : --_k) {
            is_underground = true;
            buffer = new Int16Array(this.depth);
  ...
  Application = (function() {
    ...
    function Application() {
      ...
      this.renderer.shadowMapBias = 10;
      ...
      this.world = new World(this, 900, 900, 60, 300);
    ...
    onWindowResize = function() {
      ...
      return Application.controls.handleResize();
    };
